...
public class VoxelRamp {
    ...
    public void createDiagonal(List<Vertex> vertices, float x, float y, float z, TextureRegion textureRegion) {
        ...
        Vertex b = new Vertex(x + QUAD_WIDTH, distort(y + QUAD_HEIGHT), distort(z), u1, v1);
        Vertex c = new Vertex(x, distort(y), distort(z + QUAD_WIDTH), u2, v2);

        // Tri 2
        Vertex a2 = new Vertex(x + QUAD_WIDTH, distort(y), distort(z), u1, v2);
        Vertex b2 = new Vertex(x, distort(y), distort(z + QUAD_WIDTH), u2, v2);
        Vertex c2 = new Vertex(x + QUAD_WIDTH, distort(y + QUAD_HEIGHT), distort(z), u1, v1);
